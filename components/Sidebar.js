...
export default function Sidebar() {
  ...
  return (
    <div className="text-gray-500 pl-6 pr-8 pt-8 pb-36 border-r border-gray-900 bg-black overflow-y-scroll h-screen scrollbar-hide text-xs lg:text-sm sm:max-w-[15rem] lg:max-w-[20rem] hidden md:inline-flex truncate">
